...
namespace Wanwan.Runtime
{
    public static class StageCatalog
    {
        ...
        private static readonly StageDefinition[] Stages =
        {
            ...
            new StageDefinition(2, "海岸线", "海峡拦截舰", new Color(0.01f, 0.035f, 0.09f), new Color(0.2f, 0.92f, 1f), 1.02f, 1.08f, StageCombatStyle.Flanking, BossPatternStyle.Crossfire, "海岸补给航线已打通，舰队获得前推进力。"),
