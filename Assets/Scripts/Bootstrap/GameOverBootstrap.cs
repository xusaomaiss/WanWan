    ...
    public class GameOverBootstrap : MonoBehaviour
    {
        ...
        private void BuildGameOver()
        {
            ...
            string summary = victory
                ? $"评级 {SessionState.LastRunRating}\n下一空域：深海突击区"
                : string.IsNullOrEmpty(SessionState.LastRunSummary) ? "再试一次，打穿敌方编队。" : SessionState.LastRunSummary;
            string actionCopy = victory ? "再次出击" : "重新挑战";
            ...
            UiFactory.CreateArcadeLabel(resultCard.transform, $"本局得分 {SessionState.LastScore:0000000}", 50, TextAnchor.MiddleCenter, new Color(0.95f, 0.98f, 1f), FontStyle.Bold, new Vector2(0.16f, 0.56f), new Vector2(0.84f, 0.66f), Vector2.zero);
            UiFactory.CreateArcadeLabel(resultCard.transform, $"最高分 {SessionState.HighScore:0000000}", 36, TextAnchor.MiddleCenter, new Color(0.52f, 0.84f, 1f), FontStyle.Bold, new Vector2(0.16f, 0.46f), new Vector2(0.84f, 0.54f), Vector2.zero);
            UiFactory.CreateArcadeLabel(resultCard.transform, $"难度 {BuildDifficultyText()}", 32, TextAnchor.MiddleCenter, victory ? new Color(0.86f, 0.94f, 1f) : new Color(1f, 0.76f, 0.84f), FontStyle.Bold, new Vector2(0.18f, 0.38f), new Vector2(0.82f, 0.45f), Vector2.zero);
            UiFactory.CreateArcadeLabel(resultCard.transform, summary, 28, TextAnchor.MiddleCenter, victory ? new Color(0.84f, 0.94f, 1f) : new Color(1f, 0.8f, 0.86f), FontStyle.Bold, new Vector2(0.12f, 0.2f), new Vector2(0.88f, 0.34f), Vector2.zero);
